...
export always_inline constexpr auto max(auto value) { return value; }

/// Returns the maximum of a list of values.
export always_inline constexpr auto max(auto first, auto... rest) {
    auto rhs = max(rest...);
    return first > rhs ? first : rhs;
}

/// Returns the minimum of a list of values.
export always_inline constexpr auto min(auto value) { return value; }

/// Returns the minimum of a list of values.
export always_inline constexpr auto min(auto first, auto... rest) {
    auto rhs = min(rest...);
    return first < rhs ? first : rhs;
}
...
export always_inline constexpr auto clamp(auto value, auto min, auto max) {
    return value < min
               ? min
           : value > max
               ? max
...
export template <Meta::Integral I, Meta::Float P>
