...
export constexpr PaperStock JIS_B0 = {"JIS_B0", 1030.0 * UNIT, 1456.0 * UNIT};
export constexpr PaperStock JIS_B1 = {"JIS_B1", 728.0 * UNIT, 1030.0 * UNIT};
export constexpr PaperStock JIS_B2 = {"JIS_B2", 515.0 * UNIT, 728.0 * UNIT};
export constexpr PaperStock JIS_B3 = {"JIS_B3", 364.0 * UNIT, 515.0 * UNIT};
export constexpr PaperStock JIS_B4 = {"JIS_B4", 257.0 * UNIT, 364.0 * UNIT};
export constexpr PaperStock JIS_B5 = {"JIS_B5", 182.0 * UNIT, 257.0 * UNIT};
export constexpr PaperStock JIS_B6 = {"JIS_B6", 128.0 * UNIT, 182.0 * UNIT};
export constexpr PaperStock JIS_B7 = {"JIS_B7", 91.0 * UNIT, 128.0 * UNIT};
export constexpr PaperStock JIS_B8 = {"JIS_B8", 64.0 * UNIT, 91.0 * UNIT};
export constexpr PaperStock JIS_B9 = {"JIS_B9", 45.0 * UNIT, 64.0 * UNIT};
export constexpr PaperStock JIS_B10 = {"JIS_B10", 32.0 * UNIT, 45.0 * UNIT};
export constexpr PaperStock JIS_B11 = {"JIS_B11", 22.0 * UNIT, 32.0 * UNIT};
export constexpr PaperStock JIS_B12 = {"JIS_B12", 16.0 * UNIT, 22.0 * UNIT};
