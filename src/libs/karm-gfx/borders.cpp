...
export enum struct BorderStyle : u8 {
    NONE,
...
export struct Borders {
    ...
    static Tuple<Math::Curvef, Math::Curvef, Math::Curvef, Math::Curvef> _computeCornerCurvers(Math::Radiif const& uncheckRadii, Math::Rectf const& rect) {
