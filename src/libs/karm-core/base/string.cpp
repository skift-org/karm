...
export constexpr Karm::Str operator""s(char const* buf, usize len) {
    return {buf, len};
}

export constexpr Karm::_Str<Karm::Utf8> operator""_s8(char const* buf, usize len) {
    return {buf, len};
}

export constexpr Karm::_Str<Karm::Utf16> operator""_s16(char16_t const* buf, usize len) {
