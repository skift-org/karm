...
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&&, std::integral_constant<std::size_t, 0>) {
    return __visitForward$(fn)();
}

template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 1>) {
    auto&& [_1] = __visitForward$(t);
    return __visitForward$(fn)(__visitForwardLike$(T, _1));
}

template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 2>) {
    auto&& [_1, _2] = __visitForward$(t);
    return __visitForward$(fn)(__visitForwardLike$(T, _1), __visitForwardLike$(T, _2));
}

template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 3>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 4>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 5>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 6>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 7>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 8>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 9>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 10>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 11>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 12>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 13>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 14>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 15>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 16>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 17>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 18>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 19>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 20>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 21>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 22>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 23>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 24>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 25>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 26>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 27>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 28>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 29>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 30>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 31>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 32>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 33>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 34>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 35>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 36>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 37>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 38>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 39>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 40>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 41>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 42>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 43>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 44>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 45>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 46>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 47>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 48>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 49>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 50>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 51>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 52>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 53>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 54>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 55>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 56>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 57>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 58>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 59>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 60>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 61>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 62>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 63>) {
...
template <class Fn, class T>
[[nodiscard]] constexpr decltype(auto) _visit(Fn&& fn, T&& t, std::integral_constant<std::size_t, 64>) {
