...
export module Karm.App:sdl.bridge;
...
export SDL_SystemCursor bridge(CursorStyle style) {
    switch (style) {
...
export SDL_HitTestResult bridge(HitResult result) {
    switch (result) {
    case HitResult::DRAG:
...
export App::Key bridgeSdlKeycode(SDL_Keycode sdl) {
    // clang-format off
    switch (sdl) {
...
export App::Key bridgeScancode(SDL_Scancode sdl) {
    // clang-format off
    switch (sdl) {
...
export Flags<App::KeyMod> bridgeSdlKeymod(SDL_Keymod sdl) {
...
App::KeyboardEvent fromSdlKeyboardEvent(SDL_KeyboardEvent const& sdl) {
    ...
    ev.key = bridgeSdlKeycode(sdl.key);
    ev.code = bridgeScancode(sdl.scancode);
    ev.mods = bridgeSdlKeymod(sdl.mod);
    return ev;
}

export Drm::Format bridge(SDL_PixelFormat sdl) {
    switch (sdl) {
    case SDL_PIXELFORMAT_ARGB8888:
        return Drm::Format::ARGB8888;
    case SDL_PIXELFORMAT_XRGB8888:
        return Drm::Format::XRGB8888;

    case SDL_PIXELFORMAT_ABGR8888:
        return Drm::Format::ABGR8888;
    case SDL_PIXELFORMAT_XBGR8888:
        return Drm::Format::XBGR8888;

    case SDL_PIXELFORMAT_ARGB2101010:
        return Drm::Format::ARGB2101010;
    case SDL_PIXELFORMAT_XRGB2101010:
        return Drm::Format::XRGB2101010;

    case SDL_PIXELFORMAT_ABGR2101010:
        return Drm::Format::ABGR2101010;
    case SDL_PIXELFORMAT_XBGR2101010:
        return Drm::Format::XBGR2101010;
