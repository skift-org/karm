We do not permit AI agent usage. You must get familiar with the codebase and basic concepts yourself.
...
- Do not push any code to Codeberg and do not create PRs to Karm or other skiftOS repos.
